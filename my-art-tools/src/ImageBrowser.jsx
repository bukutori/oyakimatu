...
const categories = [
    ...
    { id: 'nature', name: '自然場景', page: 22 },
    { id: 'urban', name: '都市建築', page: 31 },
];
...
// ──────────────────────────────────────────────────
function ImageBrowser({ savedImages = [], toggleFavorite }) {
    ...
    const fetchImages = useCallback(async (category) => {
        ...
        try {
            ...
            const res = await axios.get(
                `https://picsum.photos/v2/list?page=${page}&limit=${INITIAL_LIMIT}`
            );
    ...
    const handleLoadMore = async () => {
        ...
        try {
            ...
            const res = await axios.get(
                `https://picsum.photos/v2/list?page=${randomPage}&limit=${MORE_LIMIT}`
            );
    ...
    const catBtnStyle = (cat) => {
        ...
        return {
            ...
            background: isActive
                ...
                : isHovered ? '#252525' : '#181818',
            color: isActive ? '#fff' : isHovered ? '#e0e0e0' : '#888',
            fontWeight: '600',
            fontSize: '0.88rem',
            cursor: 'pointer',
    ...
    const imgWrapperStyle = (id) => {
        ...
        return {
            ...
            cursor: 'pointer',
            backgroundColor: '#111',
            boxShadow: isHov ? '0 8px 20px rgba(0,0,0,0.6)' : '0 2px 10px rgba(0,0,0,0.35)',
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', gap: '8px', overflowX: 'auto', paddingBottom: '4px' }}>
                        {pinnedImages.map(img => (
                            ...
                            >
                                <img
                                    src={`https://picsum.photos/id/${img.id}/128/96`}
                                    alt="Pinned"
                        ...
                        {loading
                            ...
                            : images.map(item => {
                                ...
                                return (
                                    ...
                                    >
                                        <img
                                            src={`https://picsum.photos/id/${item.id}/360/270`}
                                            alt={item.author}
                        ...
                        {modalMode === 'compare' ? (
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <img
                                        src={`https://picsum.photos/id/${activeImage.id}/900/675`}
