...
const TRANSLATIONS = {
  ...
  zh: {
    ...
    imageAdjustHint: '調整圖片位置與大小，讓你的明信片更精準',
    imageScale: '圖片大小',
    imageOffsetX: '水平位置',
    imageOffsetY: '垂直位置',
    storyText: '故事文字',
  ...
  JP: {
    ...
    imageAdjustHint: '画像の位置とサイズを調整して、絵葉書をきれいに仕上げましょう',
    imageScale: '画像サイズ',
    imageOffsetX: '水平位置',
    imageOffsetY: '垂直位置',
    storyText: ' ストーリーテキスト',
  ...
  en: {
    ...
    imageAdjustHint: 'Adjust image position and size to perfect your postcard',
    imageScale: 'Image Size',
    imageOffsetX: 'Horizontal Position',
    imageOffsetY: 'Vertical Position',
